        ...
        <table style="background: #fff; border-top: 6px solid #a51d29;" width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
            <tr>
                <td style="padding-top: 30px; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
                    <div class="logo">
                        <img src="<?php echo AWS_CDN_FRONT_IMG;?>logo-2.png">
                    </div>
                </td>
            </tr>
        </table>
                ...
                <tr>
                    <td style="padding-left: 20px; padding-right: 10px; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
                        <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <img style="width: 100%; max-width: 120px;" src="<?php echo AWS_CDN_FRONT_IMG;?>lock.png">
                                    <h2 style="margin: 0; font-size: 30px; color: #333;">Forgot Password</h2>
                                    <p style="margin: 8px auto;font-size: 16px;color: #828282;width: 100%;max-width: 330px;font-weight: 600;">We've received your request to forgot your password.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding-left: 20px; padding-right: 10px; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
                        <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <h2 style="margin: 0; font-size: 20px; color: #333;">Your Password Is</h2>
                                    <p style="margin: 15px auto;font-size: 16px;font-weight: 600;display: inline-block;background: #a51d29;padding: 10px 20px;border-radius: 50px;color: #fff;"><?php echo $password; ?></p>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td style="padding: 30px 20px; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
                                    <div style="display: inline-block; width: 100%; margin-bottom: 10px;">
                                        <a style="margin: 0 3px;" href=""><img src="<?php echo AWS_CDN_FRONT_IMG;?>facebook-bottom.png"></a>
                                        <a style="margin: 0 3px;" href=""><img src="<?php echo AWS_CDN_FRONT_IMG;?>twitter-bottom.png"></a>
                                        <a style="margin: 0 3px;" href=""><img src="<?php echo AWS_CDN_FRONT_IMG;?>googleplus-bottom.png"></a>
                                        <a style="margin: 0 3px;" href=""><img src="<?php echo AWS_CDN_FRONT_IMG;?>pinterest-bottom.png"></a>
                                    </div>
