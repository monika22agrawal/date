...
<div class="wraper">
    ...
    <section class="banner_area">
        <div class="container">
            <div class="banner_content">
                <h3 title="Appointment"><img class="left_img" src="<?php echo AWS_CDN_FRONT_IMG ?>banner/t-left-img.png" alt=""><?php echo lang('create_appointment');?><img class="right_img" src="<?php echo AWS_CDN_FRONT_IMG ?>banner/t-right-img.png" alt=""></h3>
            </div>
        </div>
    </section>
    <!--================End Banner Area =================--> 
    ...
    <div class="container">
        <div class="contact_form_area">
            ...
            <form id="createApp" method="post" action="<?php echo base_url('home/appointment/createMyApp/').$this->uri->segment(4).'/';?>">
                        ...
                        <div class="mob-res">
                            <div class="search_widget loc-search text-center">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="address" placeholder="<?php echo lang('enter_meeting_location'); ?>" name="appointAddress" >
                                </div>
                            </div>
                        </div>
                            ...
                            <form class="text-left frm-rgt">
                                ...
                                <div class="form-group regfld">
                                    <div class="datepicker">
                                        <input type="text" class="form-control" placeholder="<?php echo lang('enter_date_time'); ?>" id='datetimepicker4' name="appointDate" required="">
                                        <span class="dte-icn">
                                ...
                                <?php if($userDetail->appointmentType == 1){ ?>
                                    ...
                                    <div class="form-group regfld">
                                        <input type="text" min=1 maxlength=6 class="form-control" onkeypress="return isNumberKey(event);" placeholder="<?php echo lang('offer_price_palce');?>" name="offerPrice" required="">
                                    </div>
                                ...
                                <a href="javascript:void(0);">
                                    <div class="text-right">
                                        <button type="button" id="makeApp" class="btn form-control login_btn btn_focs_whte"><?php echo lang('create'); ?></button>
                                    </div>
                                </a>
                            </form>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#datetimepicker4').datetimepicker({minDate: defDate,showClose:true,format: 'YYYY-MM-DD h:mm A'});
        ...
        $("#makeApp").click(function(){
            ...
            if(add == '' || typeof add === "undefined"){
                ...
                toastr.error('<?php echo lang('select_add');?>');
                return false;
            }
            ...
            form.validate({
                ...
                messages:{
                    ...
                    appointDate : {
                        required: "<?php echo lang('select_app_date_time');?>"
                    },
                    offerPrice : {
                        required: "<?php echo lang('enter_app_ofr_price');?>"
                    }
                }
            });
