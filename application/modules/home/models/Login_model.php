...
class Login_model extends CI_Model {
	...
	function verifyEmail($data){
        ...
        if($sql->num_rows()){
            ...
            return array('status'=>0,'error'=>lang('register_already_email'));        
            ...
            if($isSend == TRUE){
                ...
                return  array('status'=>2,'error'=>lang('something_wrong'));
            }
            
            return  array('status'=>0,'error'=>lang('something_wrong'));
        }
