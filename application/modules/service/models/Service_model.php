...
class Service_model extends CI_Model {
	...
	function userInfo($id){
		...
		$uId = $id['userId'];
		$res = $this->db->select('userId,fullName,birthday,gender,email,countryCode,contactNo,emailVerified,socialId,socialType,authToken,address,latitude,longitude,isProfileUpdate,mapPayment,showTopPayment,isNotification,stripeCustomerId,subscriptionId,subscriptionStatus,eventType,appointmentType,eventInvitation')->where($id)->get(USERS);
