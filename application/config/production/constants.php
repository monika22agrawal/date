...
define('AWS_BUCKET_NAME','apoim-production');
...
define('AWS_S3_URL','https://s3.us-east-2.amazonaws.com/apoim-production/'); //S3 bucket url
define('AWS_CDN_URL', 'https://d3sndrprem3wk6.cloudfront.net/'); //cloud front url
...
/*Firebase Detail*/ // created by apoim123@gmail.com
/*define('FIREBASE_API_KEY', 'AIzaSyADUxrQxnkWGAACA66sX1VsZKfibnUHkWI');
define('FIREBASE_AUTH_DOMAIN', 'appointment-1518611631450.firebaseapp.com');
define('FIREBASE_DB_URL', 'https://appointment-1518611631450.firebaseio.com');
define('FIREBASE_PROJECT_ID', 'appointment-1518611631450');
define('FIREBASE_STORAGE_BUCKET', 'appointment-1518611631450.appspot.com');
define('FIREBASE_MESSAGING_SENDER_ID', '839320525088');*/
/*Firebase Detail*/

/*Firebase Detail*/ // created by apoimdate@gmail.com
define('FIREBASE_API_KEY', 'AIzaSyAnLPf6KhBSQgoZD8q7snEiY7Uu-fAb4_0');
define('FIREBASE_AUTH_DOMAIN', 'hazel-torus-232211.firebaseapp.com');
define('FIREBASE_DB_URL', 'https://hazel-torus-232211.firebaseio.com');
define('FIREBASE_PROJECT_ID', 'hazel-torus-232211');
define('FIREBASE_STORAGE_BUCKET', 'hazel-torus-232211.appspot.com');
define('FIREBASE_MESSAGING_SENDER_ID', '987439329837');
/*Firebase Detail*/
...
/*define('NOTIFICATION_KEY','AAAAvixJYWg:APA91bHDqxGSRnFxnYOpucijo68XmhHMTCGpoMFJnYdxmN1CuTvXHWoTeLcb41rUwism2ahc2nN3fAyfXX3Tm5foX3xcCFAyO-58f9juXZ17cPd5LettI2iEN1PhMfyqXELtgBC1Jl7R');*/

//Firebase live API key for notifications
define('NOTIFICATION_KEY','AAAA5ef4ci0:APA91bF9wb5n212Vz3s0yUghmNBp57oPP9D9MhybtQIOZ3KX7em37t8cjdlnzC1OXeO5SU-jIWEQY4vHFChSAWgFbu0SS6NN7SQkToAuVrKMkktIjgKHmIgkTaNMxFoN_f_eCt8QrVGg');
